...
export const MENU_ENTRIES: MenuEntry[] = [
	{
		...
		children: [
			...
			},
			{
				label: 'Staff Tecnico',
				href: '#',
				description: 'Entrenadores, preparacion fisica y soporte.',
			},
			{
				label: 'Instalaciones',
				href: '#',
	...
	},
	{
		...
		children: [
			...
			},
			{
				label: 'Juveniles',
				href: '#',
				description: 'Desarrollo competitivo y formativo por categorias.',
			},
			{
				label: 'Femenino',
				href: '#',
				description: 'Programa femenino, staff y proximos partidos.',
			},
		],
	},
	{
