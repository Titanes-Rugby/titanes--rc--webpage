  ...
  return (
    <AnimatedTiltCard scrollTilt>
      {({ contentX, contentY, contentScale }) => (
        <>
          <div className="absolute top-0 right-6 h-3 w-40 rounded-b-full bg-accent-500 sm:w-56 md:w-72" aria-hidden="true" />
          <div className="grid xl:grid-cols-[1.02fr_1fr]">
            <div className="relative isolate min-h-[440px] overflow-hidden bg-gradient-to-br from-titanes-500 via-titanes-600 to-titanes-700 p-5 sm:p-8">
              <Logo
                tone="light"
                label="Titanes Rugby Club watermark"
                className="pointer-events-none absolute top-1/2 left-1/2 h-[200%] w-auto max-w-none -translate-x-[46%] -translate-y-1/2 opacity-30 transition-transform duration-500 ease-out group-hover/card:scale-110"
              />
            ...
            <div className="min-w-0 space-y-6 p-6 pt-10 text-white sm:space-y-8 sm:p-8 sm:pt-12">
              <header className="space-y-4">
                <p className="text-sm font-medium tracking-[0.18em] text-white/90 uppercase sm:text-base">Position · {player.position}</p>
