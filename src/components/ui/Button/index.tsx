...
const buttonVariants = cva(
	...
	],
	{
		...
		compoundVariants: [
			...
			{ variant: 'secondary', appearance: 'filled', className: 'bg-titanes-100 text-titanes-900 hover:bg-titanes-200' },
			{ variant: 'secondary', appearance: 'outline', className: 'border border-titanes-300 text-titanes-800 hover:bg-titanes-100' },
			{ variant: 'secondary', appearance: 'gosht', className: 'text-titanes-800 hover:bg-titanes-100/70' },
