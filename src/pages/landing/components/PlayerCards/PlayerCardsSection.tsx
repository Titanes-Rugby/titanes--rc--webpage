...
export function PlayerCardsSection() {
	return (
		<section
			className="bg-gradient-to-b from-white via-primary-50/45 to-white py-20"
			aria-labelledby="player-cards-title"
		>
			<div className="mx-auto w-full max-w-6xl space-y-10 px-6 md:px-10">
				<div className="max-w-3xl space-y-3">
					<p className="text-primary-700 text-sm font-semibold tracking-[0.25em] uppercase">Perfiles de jugadores</p>
					...
					<p className="text-primary-700 text-lg">
						Diseño editorial, métricas deportivas claras y estructura reusable para escalar el roster sin tocar el
						layout.
					</p>
				</div>
