...
export function PlayerCardsSection() {
  return (
    <section className="bg-gradient-to-b from-white via-titanes-50/45 to-white py-20" aria-labelledby="player-cards-title">
      <div className="container mx-auto space-y-10 px-6 md:px-10">
        <div className="max-w-3xl space-y-3">
          ...
          <h2 id="player-cards-title" className="text-3xl leading-tight font-black text-titanes-900 md:text-5xl">
            Tarjetas de jugadores con presencia de nivel profesional
          </h2>
          <p className="text-titanes-700 text-lg">
