...
const UiShowcaseSection = () => {
	return (
		<section id="ui-showcase" data-theme="light" className="bg-titanes-50 py-20 text-titanes-900">
			<div className="mx-auto w-full max-w-6xl px-6">
				...
				<UiPreview title="Loader" className="mt-6">
					<div className="grid gap-4 sm:grid-cols-3">
						<div className="rounded-xl border border-titanes-100 bg-titanes-50/70 p-4">
				...
				<UiPreview title="Logo" className="mt-6">
					<div className="grid gap-4 sm:grid-cols-2">
						<div className="rounded-xl border border-titanes-100 bg-titanes-50/70 p-4">
							<p className="mb-3 text-xs font-semibold uppercase tracking-[0.12em] text-titanes-500">
								Primary tone
							</p>
						...
						<div className="rounded-xl bg-titanes-900 p-4">
							<p className="mb-3 text-xs font-semibold uppercase tracking-[0.12em] text-titanes-300">
								Light tone
							</p>
							<div className="flex items-end gap-4">
				...
				<UiPreview title="Marquee" className="mt-6">
					<Marquee
						items={marqueeItems}
						renderItem={(item) => (
							<div className="flex h-14 min-w-[9rem] items-center justify-center rounded-xl border border-titanes-200 bg-titanes-50 px-4 text-xs font-semibold uppercase tracking-[0.12em] text-titanes-600 transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-sm">
								{item}
							</div>
						)}
					/>
