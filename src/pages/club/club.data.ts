...
export const clubSections: ClubSection[] = [
	...
	{
		id: 'staff-tecnico',
		label: 'Cuerpo Técnico y Administrativo',
		title: 'Cuerpo Técnico y Administrativo',
		description: 'Cuerpo directivo, técnico y administrativo que gestiona operaciones y rendimiento del club.',
	},
	{
		id: 'instalaciones',
		label: 'Instalaciones',
...
export const staffMembers: StaffMember[] = [
	{
		id: 's1',
		name: 'Denis Martinez',
		role: 'Tesorera de junta directiva',
		birthDate: '1996-10-18',
		imageSrc: '/images/players/player_1.png',
		position: 'Pilar',
		rugbySince: '2024',
		focus: 'Gestion de tesoreria y apoyo administrativo de la junta directiva.',
	},
	{
		id: 's2',
		name: 'Kyara Patterson',
		role: 'Vicepresidenta de junta directiva',
		birthDate: '1996-07-10',
		imageSrc: '/images/players/Kyara_Patterson.png',
		position: 'Medio Scrum',
		rugbySince: '2023',
		focus:
			'Gestión vicepresidencial, planeación estratégica, soporte logístico como personal preventivo y de primera ayuda del club.',
	},
	{
		id: 's3',
		name: 'Pablo Galeano',
		...
		imageSrc: '/images/players/Pablo_Galeano.png',
		position: 'Pilar',
		rugbySince: '1978',
		focus:
			'Dirección técnica general, planificación estratégica de alto rendimiento, desarrollo integral de jugadores y mentoría del staff de entrenadores del club.',
	},
];
