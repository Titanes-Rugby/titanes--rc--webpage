...
export const clubSections: ClubSection[] = [
	...
	},
	{
		...
		label: 'Staff Tecnico',
		title: 'Staff Tecnico',
		description: 'Equipo de trabajo multidisciplinario para alto rendimiento.',
	},
	{
		id: 'instalaciones',
		label: 'Instalaciones',
...
export const staffMembers: StaffMember[] = [
	...
	{ id: 's2', name: 'Jorge Salinas', role: 'Forwards Coach', focus: 'Scrum, lineout y dominio del contacto.' },
	{
		...
		focus: 'Fuerza, potencia, recuperacion y prevencion de lesiones.',
	},
	{
		id: 's4',
		name: 'Laura Pineda',
		role: 'Team Manager',
		focus: 'Operacion de plantel y coordinacion de competencia.',
	},
];
...
export const facilityItems: FacilityItem[] = [
	{
		...
		detail: 'Campo reglamentario con zona tecnica y graderias para jornadas oficiales.',
	},
	{
		id: 'f2',
		title: 'Gimnasio Funcional',
		detail: 'Zona de fuerza y acondicionamiento para pretemporada y microciclos.',
	},
