...
const PILLARS = [
  {
    title: 'Hermandad',
    image: '/images/background/1103841.jpg',
    description:
      'Somos una comunidad que se apoya dentro y fuera de la cancha; el vínculo inquebrantable que nos une.',
  },
  {
    title: 'Honor',
    image: '/images/background/1103850.jpg',
    description:
      'Jugamos con integridad y respeto hacia árbitros y rivales. La dignidad está por encima del marcador.',
  },
  {
    title: 'Disciplina',
    image: '/images/background/1103868.jpg',
    description:
      'El rigor diario forma atletas íntegros; la constancia y el esfuerzo son nuestra ruta al éxito.',
  },
];
    ...
    <section className="space-y-8">
      <div className="grid items-start gap-6 lg:grid-cols-[1.15fr,1fr]">
        <header className="space-y-2">
          ...
          <p className="max-w-3xl text-sm leading-relaxed text-primary-700">
            Más que un equipo, somos una hermandad formada por estudiantes y profesionales que comparten la pasión por el rugby y el
      ...
      <div className="grid items-start gap-4 lg:grid-cols-2">
        <div className="rounded-2xl border border-primary-100 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-relaxed text-primary-700">
            Titanes Rugby Club no es solo un equipo; nació del sueño de ocho entusiastas y hoy se alza como uno de los pilares del
            rugby en el istmo. Nuestra sede principal es la UTP, donde estudiantes y profesionales desafían sus límites.
          </p>
          <p className="mt-3 text-sm leading-relaxed text-primary-700">
            Somos una brotherhood que trasciende ideologías y trasfondos. Formamos personas íntegras que llevan disciplina y respeto a
        ...
        <article className="rounded-2xl border border-primary-600 bg-gradient-to-r from-primary-700 to-primary-500 p-5 text-white shadow-md">
          ...
          <p className="mt-2 text-sm leading-relaxed">
            Cultivar el crecimiento del rugby en Panamá a través de una estructura inclusiva y competitiva, formando personas integrales
            que entiendan que la verdadera fuerza reside en la solidaridad y el apoyo mutuo.
          </p>
          <p className="mt-2 text-sm leading-relaxed">
      ...
      <article className="grid gap-4 rounded-2xl border border-primary-100 bg-white p-5 shadow-sm lg:grid-cols-[1.1fr,0.9fr]">
        <div>
          ...
          <p className="mt-2 text-sm leading-relaxed text-primary-700">
            Ser el principal referente del rugby nacional, consolidando la integración con la comunidad universitaria y expandiendo el
            impacto de todas nuestras ramas.
          </p>
