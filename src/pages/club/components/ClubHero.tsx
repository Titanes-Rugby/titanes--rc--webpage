  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-titanes-700 via-titanes-800 to-titanes-900 px-6 pb-14 pt-34 text-white sm:pt-40">
      ...
      <div className="relative mx-auto w-full max-w-6xl space-y-3">
        <p className="text-xs font-semibold tracking-[0.2em] text-titanes-100 uppercase">Club Titanes</p>
        <h1 className="text-4xl leading-tight font-black sm:text-6xl">{title}</h1>
        <p className="max-w-2xl text-base text-titanes-100/90 sm:text-lg">{description}</p>
      </div>
    </section>
  );
};
