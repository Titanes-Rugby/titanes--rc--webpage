const FixtureHero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-titanes-700 via-titanes-800 to-secondary-900 px-6 pb-14 pt-34 text-white sm:pt-40">
      ...
      <div className="mx-auto w-full max-w-6xl">
        <p className="text-xs font-semibold tracking-[0.2em] text-titanes-100 uppercase">Fixture</p>
