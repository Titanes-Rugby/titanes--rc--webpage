  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-primary-100 bg-white p-3">
      ...
      <div className="ml-auto flex items-center gap-2">
        <button type="button" onClick={() => onStatusChange('upcoming')} className={cn('rounded-full px-3 py-1.5 text-[11px] font-semibold tracking-[0.12em] uppercase', status === 'upcoming' ? 'bg-secondary-700 text-white' : 'text-secondary-700 hover:bg-secondary-100')}>Proximos</button>
