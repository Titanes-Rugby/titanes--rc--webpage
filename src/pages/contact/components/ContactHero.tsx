const ContactHero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-secondary-700 via-titanes-800 to-titanes-900 px-6 pb-14 pt-34 text-white sm:pt-40">
      ...
      <div className="mx-auto w-full max-w-6xl">
        <p className="text-xs font-semibold tracking-[0.2em] text-titanes-100 uppercase">Contacto</p>
        <h1 className="mt-3 text-4xl font-black tracking-tight sm:text-5xl">Hablemos De Rugby</h1>
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-titanes-100/90">
