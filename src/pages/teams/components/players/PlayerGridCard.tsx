    ...
    >
      {({ contentX, contentY, contentScale }) => (
        <div className="relative h-full">
          ...
          >
            ...
            >
              <PlayerPortrait
                ...
                className={cn(
                  'aspect-[4/4.7]',
                  isPanamaTheme && 'bg-gradient-to-br from-[#0057b8] via-white to-[#d21034]',
                )}
          ...
          <div className={cn('space-y-1 p-3.5 sm:p-4', isPanamaTheme && 'bg-white/80')}>
            <button
              type="button"
              onClick={() => onSelectPlayer(player)}
            ...
            >
              <h3 className={cn('text-base font-semibold sm:text-lg', isPanamaTheme ? 'text-[#0057b8]' : 'text-primary-900')}>
                {player.fullName}
              </h3>
            </button>
            ...
            {player.nationalCaps ? (
              <button
                ...
                className={cn(
                  'inline-flex cursor-pointer items-center rounded-full px-2.5 py-1 text-[10px] font-semibold tracking-[0.08em] uppercase transition-all hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-2',
                  isPanamaTheme
                    ? 'bg-[#0057b8] text-white ring-2 ring-[#0057b8]/25 hover:bg-[#004897] focus-visible:outline-[#0057b8]'
            ...
            >
              <p className={cn('text-xs sm:text-sm', isPanamaTheme ? 'text-[#0057b8]' : 'text-primary-600')}>
                Edad: {getAgeFromBirthDate(player.birthDate)}
              </p>
              <p className={cn('text-[11px] font-semibold sm:text-xs', isPanamaTheme ? 'text-[#0057b8]' : 'text-primary-500')}>
                Posición · {player.position.join(' / ')}
              </p>
              <p className={cn('text-[11px] font-semibold sm:text-xs', isPanamaTheme ? 'text-[#0057b8]' : 'text-primary-500')}>
