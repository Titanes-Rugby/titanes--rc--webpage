const PlayerCardBuilderHero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-secondary-700 via-secondary-800 to-titanes-900 px-6 pb-12 pt-34 text-white sm:pt-40">
      ...
      <div className="mx-auto w-full max-w-7xl">
        <p className="text-xs font-semibold tracking-[0.2em] text-titanes-100 uppercase">Tools</p>
