      ...
      <section className="mx-auto grid w-full max-w-[1360px] gap-6 px-6 py-8 xl:grid-cols-[360px_1fr]">
        <div className="space-y-4">
          ...
          <article className="rounded-2xl border border-titanes-100 bg-white p-5 shadow-sm">
            <h2 className="text-sm font-semibold tracking-[0.12em] text-titanes-600 uppercase">Player Data</h2>
            <p className="mt-1 text-sm text-titanes-700">Completa todos los campos para generar la tarjeta.</p>
            <div className="mt-4">
